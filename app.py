...
1. write_todos: pass a plain list of strings. Example:
   write_todos(todos=["Step one", "Step two", "Step three"])
   NEVER pass objects/dicts. ONLY plain strings in the list.
2. task: pass agent_name as a plain string and task as a plain string. Example:
   task(agent_name="researcher", task="Find benchmarks for X")
3. Do NOT invent tool arguments. Use ONLY the exact parameter names shown above.
"""
...
PIPELINES = {
    ...
    "deep_research": {
        ...
        "system_prompt": (
            ...
            "1. Call write_todos with a plain list of 4 strings like: "
            "write_todos(todos=[\"Plan research\", \"Gather data\", \"Analyse\", \"Write report\"])\n"
            "2. Call task(agent_name=\"data-analyst\", task=\"<your specific research question>\")\n"
            "3. Call write_file(filename=\"notes.md\", content=\"<paste findings here>\")\n"
            "4. Call task(agent_name=\"writer-agent\", task=\"<paste notes here>\")\n"
            "5. Output the writer-agent's response as your final answer.\n"
            "Be concise. Every tool argument must be a plain string."
        ),
        "subagents": [
            {
                "name": "data-analyst",
    ...
    "code_audit": {
        ...
        "system_prompt": (
            ...
            "1. Call write_todos(todos=[\"Check for injection\", \"Check auth\", \"Check crypto\", \"Write report\"]).\n"
            "2. Call task(agent_name=\"static-analyzer\", task=\"<paste the code here>\").\n"
            "3. write_file('findings.md', <results>).\n"
            "4. Call task(agent_name=\"fix-writer\", task=\"<paste all security findings here>\").\n"
    ...
    "data_intelligence": {
        ...
        "system_prompt": (
            ...
            "1. Call write_todos(todos=[\"Compute statistics\", \"Find insights\", \"Write report\"]).\n"
            "2. Call task(agent_name=\"stats-agent\", task=\"<paste the raw data here>\").\n"
            "3. write_file('stats.md', <results>).\n"
            "4. Call task(agent_name=\"report-writer\", task=\"<paste the stats results here>\").\n"
    ...
    "project_architect": {
        ...
        "system_prompt": (
            ...
            "1. Call write_todos(todos=[\"Research stack\", \"Estimate effort\", \"Assess risks\", \"Write plan\"]).\n"
            "2. Call task(agent_name=\"tech-researcher\", task=\"<paste the requirements here>\").\n"
            "3. Call task(agent_name=\"effort-estimator\", task=\"<paste the component list here>\").\n"
    ...
    "debug_pipeline": {
        ...
        "system_prompt": (
            ...
            "1. Call write_todos(todos=[\"Classify error\", \"Find root cause\", \"Write fix\", \"Write tests\"]).\n"
            "2. Use classify_error on the traceback.\n"
            "3. Call task(agent_name=\"root-cause-analyst\", task=\"<paste error and context here>\").\n"
            "4. write_file('root_cause.md', <analysis>).\n"
            "5. Call task(agent_name=\"fix-writer\", task=\"<paste root cause analysis here>\").\n"
    ...
    "doc_generator": {
        ...
        "system_prompt": (
            ...
            "2. Call task(agent_name=\"context-gatherer\", task=\"<paste the project description here>\").\n"
            "3. write_file('context.md', <findings>).\n"
            "4. Call task(agent_name=\"doc-writer\", task=\"<paste gathered context here>\").\n"
...
def build_agent(api_key: str, model_str: str, instructions: str, subagents_cfg: list):
    ...
    REAL create_deep_agent API (v0.0.6+):
        create_deep_agent(tools, instructions, *, model=..., subagents=[...])
        subagents dicts use 'prompt' key (NOT 'system_prompt')
    ...
    # Real deepagents subagent schema: name, description, prompt, model (optional)
    subagents = [
        {
            "name":        sa["name"],
            "description": sa["description"],
            "prompt":      sa["system_prompt"],  # key is 'prompt' in real API
            "model":       sub_model,
        }
    ...
    # Real API: create_deep_agent(tools, instructions, *, model=..., subagents=[...])
    agent = create_deep_agent(
        domain_tools,
        full_instructions,
        model=main_model,
...
with st.sidebar:
    ...
    model_notes = {
        ...
        "nvidia/llama-3.1-8b-instruct":           "✅ Fast & lightweight — lowest quota usage",
        "nvidia/llama-3.3-70b-instruct":           "✅ 70b — latest Llama 3.3",
