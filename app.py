...
1. write_todos: pass a real JSON array of todo objects, not a quoted string. Example:
   write_todos(todos=[
     {"content": "Plan research", "status": "in_progress"},
     {"content": "Gather data", "status": "pending"},
     {"content": "Write report", "status": "pending"}
   ])
   Valid statuses are exactly: pending, in_progress, completed.
2. task: pass description and subagent_type. Example:
