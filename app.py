...
with st.sidebar:
    ...
    MODEL = st.selectbox(
        ...
        index=0,   # 8b is fastest; 70b models work fine with NVIDIA (no TPM cap)
        key="model_selector",
    )
    model_notes = {
        "nvidia/llama-3.1-8b-instruct":          "✅ Fast & lightweight — great default",
        "nvidia/usdcode-llama-3.1-70b-instruct":  "✅ 70b — NVIDIA's code-optimised model",
